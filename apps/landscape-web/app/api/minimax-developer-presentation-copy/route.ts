...
import { validatePresentationCopy } from "@/lib/inclusion-presentation-copy";
import {
  getMiniMaxDeveloperPresentationCopy,
  writeMiniMaxDeveloperPresentationCopy,
} from "@/lib/minimax-developer-presentation-copy";
...
export async function GET(request: Request) {
  return NextResponse.json({
    ...
    copy: getMiniMaxDeveloperPresentationCopy(),
  });
}
...
export async function PUT(request: Request) {
  ...
  if (!validatePresentationCopy(copy)) {
    return NextResponse.json(
  ...
  await writeMiniMaxDeveloperPresentationCopy(copy);
